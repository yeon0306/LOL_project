...
이 pkl 파일을 csv로 변환한 후, 8:2 비율로 train, validation 데이터셋으로 분할하여 **CNN을 사용했다.**
...
<table>
  ...
  <tr align="center">
    <td>전체</td><td>	92%</td><td>94.2%</td></tr>
</table>
