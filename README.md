...
특히 kills, Object, goldearned, GPM은 상관 관계가 있는 데이터 속성들로, 초기에 적을 처치하였는지와 오브젝트를 활용하여 골드를 빠르게 획득하는 것이 이점을 얻는데 도움되며, 이로써 승패 예측에 관련이 있는 데이터 속성을 추출하여 딥러닝 모델인 CNN을 사용하면 팀의 승패를 보다 정확하게 예측하는 것을 알 수 있다. 
